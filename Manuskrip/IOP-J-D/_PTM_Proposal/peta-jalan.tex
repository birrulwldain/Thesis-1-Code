...
\node[splitbox={box1head}{box1body}] (box1) {
    ...
    \begin{itemize}[leftmargin=10pt, label={\color{black}$\bullet$}, itemsep=1pt]\footnotesize\color{black}
        \item Idris et al. (2004) -- Analisis emisi hidrogen padat Zircalloy
        \item Idris et al. (2007) -- Logam medium Helium laser TEA CO$_2$
        \item Suliyanti et al. (2012) -- Analisis geometri ganda pulsa rendah
        \item Idris et al. (2013) -- Dinamika atom reaktor Zircaloy
    \end{itemize}
    \end{minipage}
};
...
\node[splitbox={box2head}{box2body}, right=0.6cm of box1] (box2) {
    ...
    \begin{center}
        \vspace{-6pt}
        \textbf{\color{white}\normalsize Geokimia Lingkungan\\[1pt](2016--2020)}
        \vspace{-6pt}
    \end{center}
    ...
    \vspace{2pt}
    \begin{itemize}[leftmargin=10pt, label={\color{black}$\bullet$}, itemsep=1pt]\footnotesize\color{black}
        \item Idris et al. (2016) -- Kontaminasi tanah purba sisa Tsunami Hindia
        \item Idris et al. (2018) -- Garam di tanah pesisir pertanian
        \item Pardede et al. (2019) -- Fisika dekomposisi isotop karbon
        \item Idris et al. (2020) -- Analisis \textit{multichannel OMA}
    \end{itemize}
    \end{minipage}
};
...
\node[splitbox={box3head}{box3body}, right=0.6cm of box2] (box3) {
    ...
    \begin{center}
        \vspace{-6pt}
        \textbf{\color{black}\normalsize Tsunami \& Sedimen\\[1pt](2021--2025)}
        \vspace{-6pt}
    \end{center}
    ...
    \vspace{2pt}
    \begin{itemize}[leftmargin=10pt, label={\color{black}$\bullet$}, itemsep=1pt]\footnotesize\color{black}
        \item Mitaphonna et al. (2021) -- Lapis sedimen pesisir Aceh
        \item Mitaphonna et al. (2023) -- Identifikasi masif struktur deposit laut
        \item Idris et al. (2023) -- Silang validasi instrumen paleotsunami
        \item Ramli et al. (2023) -- Analisis elemental sedimen Tsunami
    \end{itemize}
    \end{minipage}
};
...
\node[splitbox={box4head}{box4body}, below=1.6cm of mid12, anchor=north] (box4) {
    ...
    \begin{center}
        \vspace{-6pt}
        \textbf{\color{white}\normalsize Simulasi AI \& Spektral\\[1pt](2025--2026)}
        \vspace{-6pt}
    \end{center}
    ...
    \vspace{2pt}
    \begin{itemize}[leftmargin=10pt, label={\color{black}$\bullet$}, itemsep=1pt]\footnotesize\color{black}
        \item Putri et al. (2024) -- Unsur cangkang purba
        \item Subki et al. (2025) -- Otentikasi biologis via Jaringan Saraf Tiruan ANN
        \item Walidain et al. (2025) -- Simulasi fisik sintetik plasma LTE
        \item Walidain et al. (2026) -- Model prediksi *Machine Learning* Informer
    \end{itemize}
    \end{minipage}
};
